...
QT_BEGIN_NAMESPACE
QSSGRenderDrawIndirectBuffer::QSSGRenderDrawIndirectBuffer(const QSSGRef<QSSGRenderContext> &context,
                                                               QSSGRenderBufferUsageType usageType,
                                                               QSSGByteView data)
    : QSSGRenderDataBuffer(context, QSSGRenderBufferType::DrawIndirect, usageType, data), m_dirty(true)
{
}

QSSGRenderDrawIndirectBuffer::~QSSGRenderDrawIndirectBuffer()
{
}

void QSSGRenderDrawIndirectBuffer::bind()
{
    if (m_mapped) {
...
void QSSGRenderDrawIndirectBuffer::update()
{
...
void QSSGRenderDrawIndirectBuffer::updateData(qint32 offset, QSSGByteView data)
{
