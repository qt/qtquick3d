...
class Q_QUICK3D_EXPORT QQuick3DPointLight : public QQuick3DNode
{
    Q_OBJECT
...
public:
    QQuick3DPointLight() : m_diffuseColor(Qt::white), m_specularColor(Qt::white), m_ambientColor(Qt::black) {}
