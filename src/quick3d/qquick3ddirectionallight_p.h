...
class Q_QUICK3D_EXPORT QQuick3DDirectionalLight : public QQuick3DNode
{
    Q_OBJECT
...
public:
    QQuick3DDirectionalLight() : m_diffuseColor(Qt::white), m_specularColor(Qt::white), m_ambientColor(Qt::black) {}
