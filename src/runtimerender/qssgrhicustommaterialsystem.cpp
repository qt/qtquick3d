...
QSSGRef<QSSGRhiShaderPipeline> QSSGCustomMaterialSystem::shadersForCustomMaterial(QSSGRhiContext *rhiCtx,
                                                    ...
                                                    int samples)
{
    ...
    QSSGRef<QSSGRhiShaderPipeline> shaderPipeline = shadersForCustomMaterial(rhiCtx,
                                                                           ps,
                                                                           material,
                                                                           renderable,
                                                                           featureSet,
