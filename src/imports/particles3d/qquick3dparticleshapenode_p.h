...
#ifndef QQUICK3DPARTICLESHAPENODE_H
#define QQUICK3DPARTICLESHAPENODE_H
...
class QQuick3DParticleShapeNode : public QQuick3DNode
{
    ...
    QML_NAMED_ELEMENT(ShapeNode3D)

public:
    QQuick3DParticleShapeNode(QQuick3DNode *parent = nullptr);
...
#endif // QQUICK3DPARTICLESHAPENODE_H
