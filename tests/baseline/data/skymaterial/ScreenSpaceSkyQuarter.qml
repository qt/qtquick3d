...
// As ScreenSpaceSky.qml, but skyboxMode: ScreenSpaceQuarter. The sky is rendered into a
// quarter-resolution offscreen target and upscaled to the viewport, exercising the
// reduced-scale background path (scaleDivisor == 4).
Rectangle {
    id: root
    width: 800
    height: 480
    ...
    SkyMaterial {
        ...
        skyboxMode: SkyMaterial.ScreenSpaceQuarter
