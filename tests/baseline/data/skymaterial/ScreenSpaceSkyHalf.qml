...
// As ScreenSpaceSky.qml, but skyboxMode: ScreenSpaceHalf. The sky is rendered into a
// half-resolution offscreen target and upscaled to the viewport, exercising the
// reduced-scale background path (scaleDivisor == 2).
Rectangle {
    id: root
    width: 800
    height: 480
    ...
    SkyMaterial {
        ...
        skyboxMode: SkyMaterial.ScreenSpaceHalf
