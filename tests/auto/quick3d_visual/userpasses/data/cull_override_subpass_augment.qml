...
// CullMode override in SubRenderPass with AugmentMaterial.
// The augment shader outputs opaque white regardless of the base material color.
            ...
            commands: [
                ...
                SubRenderPass {
                    renderPass: RenderPass {
                        ...
                        augmentShader: "cull_override_augment.glsl"
                        commands: [
